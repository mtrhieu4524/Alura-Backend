 ...
 * /api/profile:
 *   get:
 *     summary: Get all active users with search functionality (Admin/Staff)
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                     validation_error: "Old password is required"
 *                 errors:
 *                   type: array
 *                   items:
 *                     type: object
...
/**
 * @swagger
 * /api/profile/{userId}/deactivate:
 *   put:
 *     summary: Deactivate user account (Admin/Staff only)
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                 message:
 *                   type: string
 *                   example: "Cannot deactivate ADMIN accounts"
 *       404:
...
/**
 * @swagger
 * /api/profile/{userId}/reactivate:
 *   put:
 *     summary: Reactivate user account (Admin/Staff only)
 *     tags: [Profile]
 *     security:
 *       - bearerAuth: []
 *     parameters:
